...
<template>
  <div class="dark w-full bg-base-100 text-gray-100 h-screen font-light flex"
       data-theme="business">
    <section id="sidebar"
             class="bg-neutral/50 w-80 p-2 transition-all ease-in-out duration-500"
             :class="{ '-ml-[18rem]': !showSidebar }">
